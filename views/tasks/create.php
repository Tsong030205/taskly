    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="form-container">
                <form method="POST" action="<?php echo BASE_URL; ?>/tasks/store" class="task-form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            >
                                <option value="low" <?php echo ($old['priority'] ?? 'medium') === 'low' ? 'selected' : ''; ?>>Basse</option>
                                <option value="medium" <?php echo ($old['priority'] ?? 'medium') === 'medium' ? 'selected' : ''; ?>>Moyenne</option>
                                <option value="high" <?php echo ($old['priority'] ?? 'medium') === 'high' ? 'selected' : ''; ?>>Haute</option>
                            </select>
